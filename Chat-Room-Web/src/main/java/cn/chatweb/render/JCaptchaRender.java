package cn.chatweb.render;

import cn.chatweb.action.BaseController;
...
public class JCaptchaRender extends Render{
    ...
    //验证码随机字符数组
    private static final String[] strArr = new String[]{ "3", "4", "5", "6", "7", "8", "9", "A", "B", "C", "D", "E", "F", "G", "H",
    ...
    public JCaptchaRender(BaseController controller) {
     ...
     */
    public static boolean validate(BaseController controller, String userInputCaptcha) {
